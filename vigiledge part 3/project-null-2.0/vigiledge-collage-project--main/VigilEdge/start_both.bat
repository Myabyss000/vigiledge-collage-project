...
start "Vulnerable App" cmd /k "python vulnerable_app.py"
timeout /t 3 /nobreak >nul

echo Starting WAF on port 5000...
start "VigilEdge WAF" cmd /k "python main.py"
...
echo WAF Dashboard:   http://localhost:5000/enhanced
echo Protected Access: http://localhost:5000/protected
echo.
echo Opening protected app in 3 seconds...
timeout /t 3 /nobreak >nul
