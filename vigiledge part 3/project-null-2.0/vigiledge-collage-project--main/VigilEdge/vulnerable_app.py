        ...
        <body>
            <div class="login-container">
                <div class="login-header">
                    ...
                    <p>Please provide your admin token to continue</p>
                </div>
                ...
                <form method="GET">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="token" placeholder="Enter admin token" autocomplete="off" required>
                        </div>
                    </div>
                ...
                <div class="hint-box">
                    ...
                    <p>Try common passwords like 'admin123', 'password', '123456'</p>
                </div>
    ...
    <body>
        <div class="admin-container">
            <div class="header">
                ...
                <p>Advanced Administrative Control Panel - Security Token: admin123</p>
            </div>
            
            <nav class="nav">
                <div class="nav-container">
                    <div class="nav-links">
                        <a href="/admin?token=admin123">
                            <i class="fas fa-tachometer-alt"></i> Dashboard
                        </a>
                        <a href="/admin/users?token=admin123">
                            <i class="fas fa-users"></i> User Management
                        </a>
                        <a href="/admin/logs?token=admin123">
